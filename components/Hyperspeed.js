...
const Hyperspeed = ({ effectOptions = DEFAULT_EFFECT_OPTIONS, lightMode = false }) => {
  ...
  useEffect(() => {
    ...
    class App {
      ...
      init() {
        // loadAssets() resolves asynchronously; by then this instance may have
        // been disposed (React StrictMode double-mount, or a theme flip). Its
        // context is force-lost, and adding a pass to it throws.
